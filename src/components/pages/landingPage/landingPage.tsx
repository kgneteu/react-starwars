        ...
        <div>
            ...
            <div className={'container mx-auto'}>
                <RelatedItem
                    title={'films'}
                    stateSlice={'films'}
                    items={pageTarget.films}
                    getDataAction={getFilmsById}
                />
                <RelatedItem
                    title={'people'}
                    stateSlice={'characters'}
                    items={pageTarget.people}
                    getDataAction={getCharactersById}
                />
                <RelatedItem
                    title={'pilots'}
                    stateSlice={'characters'}
                    items={pageTarget.pilots}
                    getDataAction={getCharactersById}
                />
                <RelatedItem
                    title={'residents'}
                    stateSlice={'characters'}
                    items={pageTarget.residents}
                    getDataAction={getCharactersById}
                />
                <RelatedItem
                    title={'starships'}
                    stateSlice={'starships'}
                    items={pageTarget.starships}
                    getDataAction={getStarshipsById}
                />
                <RelatedItem
                    title={'vehicles'}
                    stateSlice={'vehicles'}
                    items={pageTarget.vehicles}
                    getDataAction={getVehiclesById}
                />
                <RelatedItem
                    title={'planets'}
                    stateSlice={'planets'}
                    items={pageTarget.planets}
                    getDataAction={getPlanetsById}
                />
                <RelatedItem
                    title={'species'}
                    stateSlice={'species'}
                    items={pageTarget.species}
